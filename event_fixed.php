        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <h5>Navigace</h5>
                    <div class="mt-3">
                        <a href="index.php" class="d-block mb-2">Domů</a>
                        <a href="events.php" class="d-block mb-2">Kalendář akcí</a>
                        <a href="page_new.php?slug=kontakt" class="d-block">Kontakt</a>
                    </div>
                </div>
            </div>
        </div>
